package com.bayusurapati.ukl_food.models

import android.os.Parcel
import android.os.Parcelable

data class RestaurentModel(val name: String?, val address: String?, val delivery_charge: String?, val image: String?, val hours: Hours?, var menus: List<Menus?>?) :
    Parcelable {
...
data class Menus(val name: String?, val price: Double, var url: String?, var totalInCart: Int) :
    Parcelable {
    constructor(parcel: Parcel) : this(
        parcel.readString(),
        parcel.readDouble(),
